...
export default function ProgramsSection() {
  ...
  const renderProgramItem = (p: typeof SETTLEMENT_PROGRAMS[number]) => (
    <li key={p.key}>
      <Link
        to={p.path}
        className="flex items-center gap-3 px-5 py-2.5 text-cream-100/85 hover:bg-emerald-700 hover:text-cream-100 transition-colors group cursor-pointer"
      >
  ...
  return (
    <section className="py-14 md:py-20 lg:py-24 bg-cream-100">
      <div className="px-6 lg:px-12">
        {/* Section Header */}
        <div className="text-center mb-12 md:mb-16 max-w-7xl mx-auto">
          <h2 className="font-serif text-3xl md:text-4xl lg:text-5xl font-semibold text-emerald-800 leading-tight mb-5">
            {t('programs.sectionTitle')}
          </h2>
          <p className="text-base text-charcoal-600/70 max-w-2xl mx-auto leading-relaxed font-light">
            {t('programs.sectionDesc')}
          </p>
        </div>

        {/* Main Layout: Green Sidebar + Description */}
