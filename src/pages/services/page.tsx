...
export default function ProgramsServicesPage() {
  ...
  const categories = [
    ...
    { key: 'settlement', label: 'Settlement & Resources' },
    { key: 'wellbeing', label: 'Wellbeing & Empowerment' },
  ];

  const programs: Program[] = [
    {
      id: 'ircc',
      titleKey: 'settlementMenu.ircc',
      descKey: '',
      icon: 'ri-government-line',
      path: '/services/ircc',
      category: 'settlement',
      stats: [
        { value: '340+', label: 'Forms & Guides' },
        { value: '89%', label: 'Success Rate' },
        { value: '6', label: 'Languages' },
      ],
    },
    {
      id: 'language-mentorship',
      titleKey: 'settlementMenu.languageMentorship',
      descKey: '',
      icon: 'ri-chat-1-line',
      path: '/services/language-mentorship',
      category: 'settlement',
      stats: [
        { value: '520', label: 'Active Pairs' },
        { value: '6mo', label: 'Avg Duration' },
        { value: '78%', label: 'Improved 2+ CLB' },
      ],
    },
    {
      id: 'private-sponsorship',
      titleKey: 'settlementMenu.privateSponsorship',
      descKey: '',
      icon: 'ri-hand-heart-line',
      path: '/services/private-sponsorship',
      category: 'settlement',
      stats: [
        { value: '145', label: 'Sponsored 2024' },
        { value: '38', label: 'Active Groups' },
        { value: '100%', label: 'Audit Pass' },
      ],
    },
    {
      id: 'language-services',
      titleKey: 'settlementMenu.languageServices',
      descKey: '',
      icon: 'ri-translate-2',
      path: '/services/language-services',
      category: 'settlement',
      stats: [
        { value: '2,400+', label: 'Translated 2024' },
    ...
    {
      id: 'settlement',
      titleKey: 'settlementMenu.immigrantSettlement',
      descKey: '',
      icon: 'ri-home-heart-line',
      path: '/services/settlement',
      category: 'settlement',
      stats: [
        { value: '4,200+', label: 'Families 2024' },
    ...
    {
      id: 'mental-health',
      titleKey: 'wellbeingMenu.mentalHealth',
      descKey: '',
      icon: 'ri-mental-health-line',
      path: '/services/mental-health',
      category: 'wellbeing',
      stats: [
        { value: '3,100', label: 'Sessions 2024' },
        { value: '92%', label: 'Reduced Distress' },
        { value: '14', label: 'Therapists' },
      ],
    },
    {
      id: 'employment',
      titleKey: 'wellbeingMenu.employment',
      descKey: '',
      ...
      stats: [
        ...
        { value: '1,850', label: 'Employed 2024' },
      ],
    },
    {
      id: 'housing',
      titleKey: 'wellbeingMenu.housing',
      descKey: '',
      icon: 'ri-building-2-line',
      path: '/services/housing',
      category: 'wellbeing',
      stats: [
        { value: '2,100', label: 'Housed 2024' },
        { value: '<24hrs', label: 'Placement' },
        { value: '94%', label: 'Stable at 12mo' },
      ],
    },
    {
      id: 'women-empowerment',
      titleKey: 'wellbeingMenu.womenEmpowerment',
      descKey: '',
      icon: 'ri-women-line',
      path: '/services/women-empowerment',
      category: 'wellbeing',
      stats: [
        { value: '1,680', label: 'Women Served' },
        { value: '340', label: 'Grads' },
        { value: '89%', label: 'Uptake Rate' },
      ],
    },
    {
      id: 'seniors',
      titleKey: 'wellbeingMenu.seniors',
      descKey: '',
      icon: 'ri-user-heart-line',
      path: '/services/seniors',
      category: 'wellbeing',
      stats: [
        { value: '520', label: 'Enrolled' },
        { value: '32/wk', label: 'Activities' },
        { value: '85%', label: 'Less Lonely' },
      ],
    },
    {
      id: 'food-security',
      titleKey: 'wellbeingMenu.foodSecurity',
      descKey: '',
      icon: 'ri-restaurant-2-line',
      path: '/services/food-security',
      category: 'wellbeing',
      stats: [
        { value: '8,400', label: 'Hampers' },
        { value: '48', label: 'Kitchen Sessions' },
  ...
  const categoryDescriptions: Record<string, string> = {
    all: 'Comprehensive services spanning settlement, legal guidance, language support, mental health, employment, housing, and community empowerment.',
    settlement: 'Newcomer lifelines — housing, language mentorship, IRCC guidance, and sponsorship pathways that transform uncertainty into opportunity.',
    wellbeing: 'Mental health, employment, housing, women\'s empowerment, seniors\' recreation, and food security — because thriving goes beyond settling.',
  };
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-14">
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <h2 className="font-serif text-2xl md:text-3xl text-cream-100 mb-3">Settlement & Resources</h2>
                <p className="text-sm text-cream-100/60 leading-relaxed mb-5 max-w-sm">
                  Five essential programs providing IRCC guidance, language mentorship, private sponsorship, translation services, and comprehensive settlement support.
                </p>
                <span className="inline-flex items-center gap-2 text-gold-400 text-sm font-semibold group-hover:gap-3 transition-all">
                  Explore directory <i className="ri-arrow-right-line" />
                </span>
              </div>
            </Link>
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <h2 className="font-serif text-2xl md:text-3xl text-cream-100 mb-3">Wellbeing & Empowerment</h2>
                <p className="text-sm text-cream-100/60 leading-relaxed mb-5 max-w-sm">
                  Six interconnected programs covering mental health, employment, housing, women\'s empowerment, seniors\' engagement, and food security.
                </p>
        ...
        <div className="max-w-6xl mx-auto">
              ...
              >
                ...
                <div className={`h-1 w-full transition-all duration-500 ${
                  hoveredCard === program.id
                    ? 'bg-gold-500'
                    : 'bg-emerald-800/20 group-hover:bg-emerald-800/40'
                }`} />
                ...
                <div className="p-6 md:p-7">
                  ...
                  <div className={`w-12 h-12 rounded-xl flex items-center justify-center mb-5 transition-all duration-300 ${
                    hoveredCard === program.id
                      ? 'bg-gold-500/10 scale-110'
                      : 'bg-emerald-800/8 group-hover:bg-emerald-800/12'
                  }`}>
          ...
          {filteredPrograms.length === 0 && (
            <div className="text-center py-16">
              ...
              <p className="text-sm text-charcoal-600/40">No programs found in this category.</p>
            </div>
          )}
        </div>
      </section>
            ...
            {[
              {
                ...
                desc: 'Call, email, or visit. Our multilingual intake team responds within 24 hours.',
                icon: 'ri-phone-line',
              },
              {
                step: '02',
                title: 'Needs Assessment',
                desc: 'A confidential, culturally sensitive assessment identifies your priorities and goals.',
                icon: 'ri-clipboard-line',
              },
              {
                step: '03',
                title: 'Service Matching',
                desc: 'You are matched with the right program and assigned a dedicated case worker.',
                icon: 'ri-link-m',
              },
              {
                step: '04',
                title: 'Ongoing Support',
                desc: 'Continuous care with regular check-ins and access to additional services as needed.',
      ...
      <section className="px-6 lg:px-10 py-14 md:py-20 bg-emerald-900">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-sm md:text-base text-cream-100/60 mb-8 max-w-xl mx-auto leading-relaxed">
            Whether you are seeking services, volunteering, or partnering with WORI, we are here to connect. All services are free and confidential.
          </p>
